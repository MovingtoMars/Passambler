...
public class EncryptFunction extends Value implements Function {
    @Override
    ...
    public Value invoke(FunctionContext context) throws EngineException {
        ...
        try {
            if (context.getArgument(0) instanceof StringValue) {
                ...
                return new StringValue(encryptor.encrypt(((StringValue) context.getArgument(1)).toString()));
                ...
                return new NumberValue(encryptor.encrypt(((NumberValue) context.getArgument(1)).getValue()));
            }
